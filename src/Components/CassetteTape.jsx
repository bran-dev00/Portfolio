        ...
        <g id="Cassette Tape" filter="url(#filter0_d_46_164)">
          <g id="Cassette Case">
            ...
            <rect
              ...
              stroke="#215A84"
              stroke-width="86"
              mask="url(#path-1-inside-1_46_164)"
            />
          </g>
          <g id="Cassette Tape_2">
            ...
            <rect
              ...
              stroke="#071D54"
              stroke-width="86"
              mask="url(#path-2-inside-2_46_164)"
            />
          </g>
          <g id="Screws">
            <g id="Screw">
              ...
              <g id="cross">
                ...
                <rect
                  ...
                  width="3.63636"
                  height="0.727273"
                  transform="rotate(-90 19.6364 23.8182)"
                  fill="#071D54"
                />
              </g>
              <g id="Screw_2">
            ...
            <g id="Screw_3">
              ...
              <g id="cross_3">
                ...
                <rect
                  ...
                  width="3.63636"
                  height="0.727273"
                  transform="rotate(-90 16.6364 191.818)"
                  fill="#071D54"
                />
              </g>
              <g id="Screw_4">
            ...
            <g id="Screw_5">
              ...
              <g id="cross_5">
                ...
                <rect
                  ...
                  width="3.63636"
                  height="0.727273"
                  transform="rotate(-90 286.636 191.818)"
                  fill="#071D54"
                />
              </g>
              <g id="Screw_6">
            ...
            <g id="Screw_7">
              ...
              <g id="cross_7">
                ...
                <rect
                  ...
                  width="3.63636"
                  height="0.727273"
                  transform="rotate(-90 286.636 23.8182)"
                  fill="#071D54"
                />
              </g>
            </g>
          ...
          <g id="Labels" filter="url(#filter1_d_46_164)">
            <path
              d="M24 43C24 37.4771 28.4772 33 34 33H273C278.523 33 283 37.4772 283 43V143H24V43Z"
              fill="#9DF3FF"
            />
          </g>
          <g id="Spools">
            <g id="Spool">
              ...
              <g id="InnerSpool">
                <circle
                  ...
                  cy="87.6752"
                  r="19.8"
                  transform="rotate(-42 214.133 87.6752)"
                  fill="white"
                  stroke="white"
                />
                <circle
                ...
                <path
                  id="Rectangle 1"
                  d="M222.929 100.882L226.797 97.3986L233.763 105.135L229.895 108.618L222.929 100.882Z"
                  fill="#071D54"
                />
                <path
                  id="Rectangle 5"
                  d="M211.008 103.541L216.206 103.814L215.661 114.21L210.463 113.937L211.008 103.541Z"
                  fill="#071D54"
                />
                <path
                  id="Rectangle 7"
                  d="M198.85 84.2492L197.679 89.3209L187.535 86.9791L188.706 81.9074L198.85 84.2492Z"
                  fill="#071D54"
                />
                <path
                  id="Rectangle 8"
                  d="M217.961 71.0585L212.795 71.6929L211.526 61.3602L216.693 60.7259L217.961 71.0585Z"
                  fill="#071D54"
                />
                <path
                  id="Rectangle 6"
                  d="M230.295 91.1283L230.567 85.9303L240.963 86.4752L240.691 91.6732L230.295 91.1283Z"
                  fill="#071D54"
                />
                <path
                  id="Rectangle 2"
                  d="M195.495 70.4126L199.363 66.9297L206.329 74.6661L202.46 78.149L195.495 70.4126Z"
                  fill="#071D54"
                />
                <rect
                  id="Rectangle 3"
                  ...
                  width="5.20512"
                  height="10.4102"
                  transform="rotate(-132 196.606 106.02)"
                  fill="#071D54"
                />
                <rect
                  id="Rectangle 4"
                  ...
                  width="5.20512"
                  height="10.4102"
                  transform="rotate(-132 227.075 78.5856)"
                  fill="#071D54"
                />
              </g>
            </g>
            <g id="Spool_4">
              ...
              <g id="InnerSpool_2">
                <circle
                  ...
                  cy="87.6752"
                  r="20.3"
                  transform="rotate(-42 94.1329 87.6752)"
                  fill="white"
                />
                <path
                  id="Rectangle 1_2"
                  d="M102.929 100.882L106.797 97.3986L113.763 105.135L109.895 108.618L102.929 100.882Z"
                  fill="#071D54"
                />
                <path
                  id="Rectangle 5_2"
                  d="M91.0081 103.541L96.2061 103.814L95.6612 114.21L90.4632 113.937L91.0081 103.541Z"
                  fill="#071D54"
                />
                <path
                  id="Rectangle 7_2"
                  d="M78.8498 84.2492L77.6789 89.3209L67.5355 86.9791L68.7064 81.9074L78.8498 84.2492Z"
                  fill="#071D54"
                />
                <path
                  id="Rectangle 8_2"
                  d="M97.9614 71.0585L92.795 71.6929L91.5263 61.3602L96.6927 60.7259L97.9614 71.0585Z"
                  fill="#071D54"
                />
                <path
                  id="Rectangle 6_2"
                  d="M110.295 91.1283L110.567 85.9303L120.963 86.4751L120.691 91.6731L110.295 91.1283Z"
                  fill="#071D54"
                />
                <path
                  id="Rectangle 2_2"
                  d="M75.4947 70.4126L79.3629 66.9297L86.3287 74.666L82.4605 78.1489L75.4947 70.4126Z"
                  fill="#071D54"
                />
                <rect
                  id="Rectangle 3_2"
                  ...
                  width="5.20512"
                  height="10.4102"
                  transform="rotate(-132 76.6062 106.02)"
                  fill="#071D54"
                />
                <rect
                  id="Rectangle 4_2"
                  ...
                  width="5.20512"
                  height="10.4102"
                  transform="rotate(-132 107.075 78.5856)"
                  fill="#071D54"
                />
              </g>
            </g>
            ...
            <g id="Screw_8">
              ...
              <g id="cross_8">
                ...
                <rect
                  ...
                  width="3.18182"
                  height="0.636364"
                  transform="rotate(-90 154.182 169.091)"
                  fill="#071D54"
                />
              </g>
              <g id="Screw_9">
                ...
                <g id="cross_9">
                  ...
                  <rect
                    ...
                    width="3.63636"
                    height="0.727273"
                    transform="rotate(-90 153.636 169.818)"
                    fill="#071D54"
                  />
                </g>
              </g>
        ...
        <defs>
          ...
          >
            ...
            <feBlend
              ...
              result="effect1_dropShadow_46_164"
            />
            <feBlend
              mode="normal"
              in="SourceGraphic"
              in2="effect1_dropShadow_46_164"
              result="shape"
            />
          </filter>
          <filter
